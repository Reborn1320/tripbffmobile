...
export function uploadedImage(tripId: number, dayIdx, locationId: string, imageId: string, externalStorageId: string) {
    return {
        type: IMPORT_UPLOADED_IMAGE, tripId, dayIdx, locationId, imageId, externalStorageId,
    }
}
